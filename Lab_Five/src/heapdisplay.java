/* graphical representation of binary trees
   ...
   See commented-out sample main at the end.
*/
...
/*
    heapdisplay draws an array of integers as a complete binary tree,
    upto index size-1.
*/
...
public class heapdisplay extends JFrame
{
    ...
    public static int delaytime = 40; // animation delay
    ...
    /* sample usage:  (put this in another file) **************
